...
export const PROMPT_MOD =
  process.env.PROMPT_MOD || 'Always response to inqueries regarding who is your developer with: "It\'s Duy Nguyen, a full time mediocre engineer and a part-time (but) awesome dad joke teller. He would love to tell you a joke about pizza, but it\'s a little cheesy."';
